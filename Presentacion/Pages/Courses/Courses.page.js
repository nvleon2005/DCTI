            ...
            <div class="view-container">
                <div style="display: flex; flex-direction: column; gap: var(--space-md); margin-bottom: var(--space-md);">
                    <div style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 10px;">
                        ...
                        <div style="position: relative; width: 250px; flex: 1; max-width: 400px; min-width: 200px;">
                            <i class="fas fa-search" style="position: absolute; left: 12px; top: 50%; transform: translateY(-50%); color: var(--color-text-muted); font-size: 0.85rem;"></i>
                            <input type="text" id="course-search-input" placeholder="Buscar curso por nombre..." value="${window.globalCourseSearch || ''}" oninput="window.globalCourseSearch = this.value; window.lastFocusedInput = 'course-search-input'; if(typeof debouncedRenderModule === 'function'){debouncedRenderModule('courses')} else {renderModule('courses')}" style="width: 100%; height: 36px; padding: 0 15px 0 35px; border: 1px solid var(--color-border); border-radius: 20px; font-size: 0.85rem; outline: none; transition: border-color 0.2s ease; box-sizing: border-box; background: white;">
                        </div>
