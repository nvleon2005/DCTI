                    ...
                    <form id="dcti-admin-form" style="display: flex; flex-direction: column; gap: var(--space-md); width: 100%;">
                        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(min(100%, 300px), 1fr)); gap: var(--space-xl); box-sizing: border-box;">
                            ...
                            <div style="display: flex; flex-direction: column;">
                                ...
                                <div style="position: relative; width: 100%; min-height: 280px; background: #f8fafc; border-radius: 8px; border: 2px dashed var(--color-border); display: flex; align-items: center; justify-content: center; padding: 10px;">
                                    <img id="admin-dcti-organigrama-preview" src="${dcti.organigrama || ''}" style="max-width: 100%; max-height: 500px; height: auto; object-fit: contain; border-radius: 8px; display: ${dcti.organigrama ? 'block' : 'none'};">
